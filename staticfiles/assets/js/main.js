...
(function() {
  ...
  /**
   * Apply .scrolled class to the body as the page is scrolled downdocument.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (event) {
      ...
      fetch(form.action, {
        ...
        .then((data) => {
          ...
          setTimeout(() => {
            window.location.reload(); // Reload to reflect submission
          }, 2000);
        })
        .catch((error) => {
          ...
          if (errorMessage) {
            ...
            errorMessage.textContent = "There was an error submitting your booking.";
          }
        });
    });
  }
  ...
  document.addEventListener('DOMContentLoaded', function() {
    // Add form-control classes to specific input elements if they exist
